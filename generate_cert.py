...
def generate_self_signed_cert():
    print("[*] Generating 2048-bit Private Key...")
    ...
    subject = issuer = x509.Name([
        ...
        x509.NameAttribute(NameOID.LOCALITY_NAME, u'Malibu'),
        x509.NameAttribute(NameOID.ORGANIZATION_NAME, u'Stark Industries'),
    ...
    print("[+] Success: 'server.key' and 'server.crt' created.")
